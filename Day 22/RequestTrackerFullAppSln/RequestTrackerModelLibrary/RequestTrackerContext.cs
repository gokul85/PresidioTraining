    ...
    public class RequestTrackerContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Employee>().HasData(
                new Employee { Id = 101, Name = "Ramu",Username = "Ramu", Password = "ramu123", Role = "Admin" },
                new Employee { Id = 102, Name = "Somu",Username = "Somu", Password = "somu123", Role = "Admin" },
                new Employee { Id = 103, Name = "Bimu",Username = "Bimu", Password = "bimu123", Role = "User" }
                );
