...
namespace EmployeeRequestTrackerAPI.Services
{
    public class UserService : IUserService
    {
        ...
        public async Task<Employee> Register(EmployeeUserDTO employeeDTO)
        {
            ...
            try
            {
                employee = MapEmployeeUserDTOToEmployee(employeeDTO);
        ...
        private Employee MapEmployeeUserDTOToEmployee(EmployeeUserDTO employeeDTO)
        {
        ...
        {
            User ud = await _userRepo.Get(userUpdateStatusDTO.UserId);
            if (ud != null)
            {
                ud.Status = userUpdateStatusDTO.Status;
                await _userRepo.Update(ud);
