...
async function main() {
    ...
    const STORAGE_CONNECTION_STRING = process.env.STORAGE_CONNECTION_STRING || "BlobEndpoint=https://gokulsacc.blob.core.windows.net/;QueueEndpoint=https://gokulsacc.queue.core.windows.net/;FileEndpoint=https://gokulsacc.file.core.windows.net/;TableEndpoint=https://gokulsacc.table.core.windows.net/;SharedAccessSignature=sv=2022-11-02&ss=bfqt&srt=sco&sp=rwdlacupiytfx&se=2024-07-16T16:51:21Z&st=2024-07-16T08:51:21Z&spr=https,http&sig=SfQhyJ8eb77R8o17sLRnoQR0ExbzbJyvtjsZcfgKkio%3D";
